/**
 * @file Debug_log.hpp
 * @brief Debug log utility
 * @author SkyWodd
 * @version 1.0
 * @see http://skyduino.wordpress.com/
 *
 * @section intro_sec Introduction
 * This header is a functions bundle of various debug utilities (template functions).\n
 ...
 * Use clog as output (can be easily redirected to a file).
 */
...
/**
 * Output variable to debug log stream (using << operator overload)
 *
 * @pre Target variable MUST define << operator overload !
 ...
 * @remark Define / undefine DEBUG to enable / disable debug output
 *
 * @param str Label to display before the variable
 * @param var Target variable to display
 */
#ifdef DEBUG
template<typename T>
